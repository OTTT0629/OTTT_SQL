...
(
	role_to_permission_no 	char(1) primary key
...
(
	--영상장르번호
	content_genre_no	bigint		generated always as identity primary key
...
create table tb_producer (
	producer_no		bigint		generated always as identity primary key
...
create table tb_content_director (
	cont_director_no	bigint	generated always as identity primary key
...
create table tb_content_entertainer (
	cont_entertainer_no	bigint	generated always as identity primary key
